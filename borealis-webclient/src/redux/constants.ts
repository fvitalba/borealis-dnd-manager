...
export const UPDATE_TOKEN_NAME = 'TOKEN/UPDATE_TOKEN_NAME'
export const UPDATE_TOKEN_IMAGEURL = 'TOKEN/UPDATE_TOKEN_IMAGEURL'
export const UPDATE_TOKEN_MAPID = 'TOKEN/UPDATE_TOKEN_MAPID'

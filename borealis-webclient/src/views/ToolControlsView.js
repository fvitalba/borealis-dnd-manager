		...
		case 'draw':
			return (
				<span>
					...
					<input size='3' title='draw size' value={ drawSize } onChange={ (e) => setDrawSize(e) } type='number' step='3' min='1' />
					<input size='3' title='draw color' value={ drawColor } onChange={ (e) => setDrawColor(e) } />
		...
		case 'fog':
			return (
				<span>
					...
					<input size='3' title='fog radius' value={ fogRadius || 0 } onChange={ (e) => setFogRadius(e) } type='number' step='5' min='1' />
					<input size='3' title='fog opacity' step='0.05' min='0' max='1' value={ fogOpacity } onChange={ (e) => setFogOpacity(e) } type='number' />
				</span>
			)
		default:
			return null
